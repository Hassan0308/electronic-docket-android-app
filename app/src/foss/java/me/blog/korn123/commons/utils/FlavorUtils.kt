...
object FlavorUtils {
    fun sequenceToSymbolResourceId(sequence: Int) = when (sequence) {
        ...
        WEATHER_SUNNY -> R.drawable.sunny
        WEATHER_CLOUD_AND_SUN -> R.drawable.sunny_and_cloudy
        WEATHER_RAIN_DROPS -> R.drawable.rainy
        WEATHER_BOLT -> R.drawable.bolt
        WEATHER_SNOWING -> R.drawable.snow
