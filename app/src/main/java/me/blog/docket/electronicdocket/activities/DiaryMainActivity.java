    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.chart:
                ...
                break;
            case R.id.animation:
                Intent animation = new Intent(DiaryMainActivity.this, MainActivity.class);
            ...
            case R.id.reminder:
                ...
                if (calIntent.resolveActivity(getApplicationContext().getPackageManager()) != null) {
                    startActivity(calIntent);

                } else {
                    Toast.makeText(getApplicationContext(), "Calendar application does not exist.please install from play store", Toast.LENGTH_LONG).show();
