...
import com.example.paintapplication.MainActivity;
...
import me.blog.docket.commons.utils.BitmapUtils;
import me.blog.docket.commons.utils.CommonUtils;
import me.blog.docket.commons.utils.DateUtils;
import me.blog.docket.commons.utils.DialogUtils;
import me.blog.docket.commons.utils.FontUtils;
import me.blog.docket.commons.utils.PermissionUtils;
import me.blog.docket.electronicdocket.R;
import me.blog.docket.electronicdocket.adapters.DiaryWeatherItemAdapter;
import me.blog.docket.electronicdocket.helper.EasyDiaryDbHelper;
import me.blog.docket.electronicdocket.models.DiaryDto;
import me.blog.docket.electronicdocket.models.PhotoUriDto;
...
public class DiaryInsertActivity extends EasyDiaryActivity {
    ...
    @OnClick({R.id.speechButton, R.id.zoomIn, R.id.zoomOut, R.id.saveContents, R.id.photoView, R.id.datePicker, R.id.timePicker, R.id.drawing})
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.zoomOut:
                ...
                break;
            case R.id.drawing:
                Intent animation = new Intent(DiaryInsertActivity.this, MainActivity.class);
...
//                android.R.layout.simple_spinner_item, weatherArr);
    ...
    private void initShowcase() {
        ...
        mShowcaseView = new ShowcaseView.Builder(this)
                ...
                .setOnClickListener(showcaseViewOnClickListener).hideOnTouchOutside()
                .build();
